...
<body>
  ...
  <div class="menu">
    <a href="index.php">
      <h3>
        <font color="#ffc100">Catfish</font>Diagnosis 
      </h3>
    </a>
  ...
  <div class="galery">
    ...
    <div class="judul">
      Selamat datang Sistem Pakar <B>Catfish Diagnosis</b>
      (Diagnosa Penyakit Pada Ternak Ikan Lele Berbasis Website)
      <img src="img/cat_fish.png"height="410">

    </div>

    <div class="isi">
    Sistem pakar ini memiliki basis pengetahuan yang mencakup informasi tentang berbagai jenis penyakit yang dapat menyerang ikan lele, termasuk deskripsi gejala, faktor penyebab, dan metode pengobatan yang mungkin. Informasi ini disimpan dalam database untuk memudahkan akses dan pembaruan.
      <br>
      <br>
      <br>
